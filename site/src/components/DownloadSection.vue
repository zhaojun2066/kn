  ...
  <section class="dl section" id="download">
    <div class="container">
      <div class="dl-header reveal">
        ...
        <p class="section-desc">前往 GitHub Releases 下载 macOS 版本。</p>
      </div>

      <div class="dl-actions reveal">
        <a :href="GITHUB_RELEASES" target="_blank" rel="noopener" class="btn btn-primary dl-btn">
        ...
        <p class="dl-ver">最新版本 v{{ APP_VERSION }} · macOS 12+</p>
      </div>
    </div>
  </section>
</template>
