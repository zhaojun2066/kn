...
function scrollToSection(id: string) {
  ...
  if (el) {
    ...
    // Fallback: navigate to home then scroll (hash router may have redirected)
  ...
  <nav class="nav" :class="{ 'nav-scrolled': scrolled }">
    <div class="nav-inner">
      <a href="#/" class="nav-brand">
        ...
        <span class="nav-name">KN</span>
      </a>

      <!-- Desktop links -->
      <div class="nav-links">
        <a href="#/" @click.prevent="scrollToSection('features')">特性</a>
        <a href="#/" @click.prevent="scrollToSection('mobile')">移动端</a>
        <a href="#/docs">文档</a>
        ...
        <a href="#/" @click.prevent="scrollToSection('download')" class="nav-cta">下载</a>
      </div>
    ...
    <div class="nav-mobile" :class="{ open: mobileOpen }">
      <a href="#/" @click="mobileOpen = false; scrollToSection('features')">特性</a>
      <a href="#/" @click="mobileOpen = false; scrollToSection('mobile')">移动端</a>
      <a href="#/docs" @click="mobileOpen = false">文档</a>
      <a href="#/" @click="mobileOpen = false; scrollToSection('download')" class="nav-cta-mobile">下载</a>
    </div>
  </nav>
</template>
